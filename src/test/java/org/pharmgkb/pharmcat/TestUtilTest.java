...
public class TestUtilTest {
  ...
  public void testAssertDiplotypePairs() {
    ...
    TestUtil.assertDiplotypePairs(
        ...
        Lists.newArrayList(
            new DiplotypeMatch(hm1, hm1, dataset),
            new DiplotypeMatch(hm2, hm4, dataset)
        )
    );
    ...
    TestUtil.assertDiplotypePairs(
        ...
        Lists.newArrayList(
            new DiplotypeMatch(hm1, hm1, dataset),
            new DiplotypeMatch(hm1, hm3, dataset),
            new DiplotypeMatch(hm2, hm4, dataset),
            new DiplotypeMatch(hm3, hm4, dataset)
        )
    );
  ...
  public void testAssertDiplotypePairsMismatch() {
    ...
    TestUtil.assertDiplotypePairs(
        ...
        Lists.newArrayList(
            new DiplotypeMatch(hm1, hm1, dataset),
            new DiplotypeMatch(hm2, hm2, dataset)
        )
    );
  }
  ...
  public void testAssertDiplotypePairsRightOrder() {
    ...
    TestUtil.assertDiplotypePairs(
        ...
        Lists.newArrayList(
            new DiplotypeMatch(hm2, hm1, dataset),
            new DiplotypeMatch(hm1, hm2, dataset)
        )
    );
  }
