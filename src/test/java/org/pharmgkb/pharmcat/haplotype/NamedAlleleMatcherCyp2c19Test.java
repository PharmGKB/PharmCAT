...
class NamedAlleleMatcherCyp2c19Test {
  ...
  void cyp2c19s4as4b() throws Exception {
    ...
    List<String> expectedMatches = Lists.newArrayList("*4/*4");
  ...
  void cyp2c19s15s28() throws Exception {
    ...
    List<String> expectedMatches = Lists.newArrayList("*15/*28", "*28/*39");
  ...
  void s4bs17rs28399504missing() throws Exception {
    ...
    List<String> expectedMatches = Lists.newArrayList("*17/*17", "*17/*4", "*4/*4");
  ...
  void s2s35() throws Exception {
    Path vcfFile = PathUtils.getPathToResource("org/pharmgkb/pharmcat/haplotype/cyp2c19/noCall.vcf");
    List<String> expectedMatches = Lists.newArrayList();
