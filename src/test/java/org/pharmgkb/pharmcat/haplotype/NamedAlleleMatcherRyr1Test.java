 ...
 * @author Mark Woon
 */
class NamedAlleleMatcherRyr1Test {
  ...
  static void prepare() throws IOException, ReportableException {
    s_env = new Env();
    s_definitionFile = s_env.getDefinitionReader().getDefinitionFile("RYR1");
  }
  ...
  void reference(TestInfo testInfo) throws Exception {
    ...
    Result rez = testMatchNamedAlleles(s_env, sf_definitionFile, new TestVcfBuilder(testInfo, "ref/ref")
        .reference("RYR1")
        .generate());
