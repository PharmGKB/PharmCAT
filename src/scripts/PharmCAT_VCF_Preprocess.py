...
def run(args):
    ...
    convert_to_normalized_vcf_args.output_folder = Utilities.obtain_folder_path(args.output_folder)
    ...
    convert_to_pharmcat_vcf_args.input_vcf = os.path.join(convert_to_normalized_vcf_args.output_folder, Utilities.AppendCompressedVCFSuffix(convert_to_normalized_vcf_args.output_prefix))
