...
class Test(TestCase):
    ...
    def test_preprocess_concurrent(self):
        pharmcat_positions = Path(script_dir, '../../../pharmcat_positions.vcf.bgz')
        reference_fasta: Path = get_reference_fasta(pharmcat_positions)
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            basename = 'preprocess'
            preprocess(pharmcat_positions, reference_fasta, [tmp_vcf], None, basename, tmp_dir, basename,
    ...
    def test_preprocess_multi_vcf_concurrent(self):
        pharmcat_positions = Path(script_dir, '../../../pharmcat_positions.vcf.bgz')
        reference_fasta: Path = get_reference_fasta(pharmcat_positions)
