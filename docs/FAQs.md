...
If you have access to whole genome sequencing (WGS) CRAM/BAM files, we strongly discourage calling CYP2D6 using PharmCAT. Please refer to our documentation about CYP2D6 calling (https://pharmcat.org/technical-docs/calling-cyp2d6/).
