...
vcfMissingTests:
	...
	${GRADLE_CMD} testAutogeneratedVcfs
	cd build; zip -r vcfTest-`date +'%Y-%m-%d'-missing`.zip autogeneratedTestResults
...
exactVcfMissingTests:
	...
	src/scripts/generate_vcf_test_data.sh -m
	${GRADLE_CMD} testAutogeneratedVcfsExactMatchOnly
	cd build; zip -r vcfTest-`date +'%Y-%m-%d'`-exact-missing.zip autogeneratedTestResults
...
fuzzyVcfMissingTests:
	...
	src/scripts/generate_vcf_test_data.sh -m
	${GRADLE_CMD} testAutogeneratedVcfsFuzzyMatch
	cd build; zip -r vcfTest-`date +'%Y-%m-%d'`-fuzzy-missing.zip autogeneratedTestResults
